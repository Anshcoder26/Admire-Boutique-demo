    ...
    <main>
        ...
        <div className="relative isolate overflow-hidden rounded-xl bg-[#7D1D1D] p-6 text-white shadow-[var(--shadow-lg)] md:p-12">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center">
            <div>
              ...
              <div className="mt-8">
                <ButtonLink href="/products" variant="secondary" size="lg" className="bg-white text-[#7D1D1D] hover:bg-white/90">
      ...
      <Section spacing="md">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={feature.title} className="group rounded-lg border border-[var(--ink)]/10 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#7D1D1D]/30 hover:shadow-[var(--shadow-md)]">
      ...
      <Section spacing="md">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {reviews.map((review) => (
            <article key={review.name} className="group rounded-lg border border-[var(--ink)]/10 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#7D1D1D]/30 hover:shadow-[var(--shadow-md)]">
