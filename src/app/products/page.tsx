    ...
    <main className="px-4 py-8 md:px-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex items-center gap-2 md:gap-3">
          <LotusOrnament className="h-10 w-10 md:h-12 md:w-12 rounded-full border border-[#d7c1af] bg-white/80 p-2" />
          <div>
        ...
        <div className="grid gap-4 md:gap-6 xl:grid-cols-[280px_1fr]">
          <aside className="hidden xl:block rounded-[30px] border border-[#eadcd3] bg-[#fffaf6] p-5 shadow-[0_12px_26px_rgba(84,58,45,0.04)]">
