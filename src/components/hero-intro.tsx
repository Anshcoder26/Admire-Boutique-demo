      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-[32px] bg-gradient-to-br from-[#fff5f0] to-[#f4ece6] p-8 shadow-[0_20px_50px_rgba(125,29,29,0.12)] md:p-10 lg:p-12 border border-[#D4AF37]/20 hover:shadow-[0_20px_60px_rgba(125,29,29,0.18)] transition-all duration-300">
            ...
            <h1 className="leading-tight hover:animate-float">

              <span
                className="block bg-gradient-to-r from-[#7D1D1D] via-[#8B7355] to-[#D4AF37]
                           bg-clip-text text-transparent text-5xl md:text-6xl lg:text-7xl"
                style={{ fontFamily: "'Alex Brush', cursive" }}
              >
                Rooted in tradition.
              </span>

              <span className="mt-2 block font-serif text-5xl font-bold text-[#8B7355] md:text-6xl lg:text-7xl">
                Made for today.
              </span>
