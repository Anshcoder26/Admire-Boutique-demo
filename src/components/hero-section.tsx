  ...
  return (
    <section className="indian-branch relative overflow-hidden bg-gradient-to-br from-[#fef9f5] via-[#f5e6f0] to-[#e8f4f8] px-4 pb-12 pt-6 md:px-8 lg:px-10">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute top-10 left-10 w-72 h-72 bg-gradient-to-br from-[#d81e8f]/20 to-transparent rounded-full blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-[32px] bg-gradient-to-br from-[#fff5f0] to-[#f0e8f5] p-8 shadow-[0_20px_50px_rgba(216,30,143,0.12)] md:p-10 lg:p-12 border border-[#f4a500]/20">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#d81e8f]/30 bg-gradient-to-r from-[#d81e8f]/10 to-[#6f2fbf]/10 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.25em] text-[#d81e8f]">
              <Sparkles className="h-4 w-4 animate-pulse" />
              Festival Collection
            </div>
            
            <h1 className="font-serif text-5xl leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#d81e8f] via-[#6f2fbf] to-[#00a8cc] md:text-6xl lg:text-7xl font-bold">
              Rooted in tradition.
              <span className="block text-gradient-to-r from-[#f4a500] to-[#ff6b35] mt-2">Made for today.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:gap-3">
              <Link
                href="/products"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#d81e8f] to-[#a81566] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#d81e8f]/30 transition-all hover:shadow-xl hover:shadow-[#d81e8f]/50 hover:scale-105 active:scale-95"
              >
                Shop Now
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4">
              <div className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-[#d81e8f]/10 to-[#f4a500]/10 px-5 py-3 border border-[#d81e8f]/20">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold uppercase tracking-wider text-[#6f2fbf]">Happy Customers</span>
                  <span className="text-2xl font-bold text-[#d81e8f]">14k+</span>
                </div>
              </div>
              <div className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-[#f4a500]/10 to-[#00a8cc]/10 px-5 py-3 border border-[#f4a500]/20">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold uppercase tracking-wider text-[#00a8cc]">Rating</span>
                  <span className="text-2xl font-bold text-[#f4a500]">4.8★</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[450px] overflow-hidden rounded-[32px] bg-gradient-to-br from-[#fff5f0] via-[#f5e8f5] to-[#e8f8f9] p-6 shadow-[0_25px_50px_rgba(216,30,143,0.15)] border border-[#f4a500]/20">
            {/* Animated background pattern */}
            <div className="absolute inset-0 opacity-30">
              <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-[#d81e8f] rounded-full blur-3xl animate-pulse" />
            ...
            <div className="relative flex h-full items-end justify-center">
              <div className="relative h-[380px] w-[280px] rounded-[28px] bg-gradient-to-b from-[#fff5f0] to-[#f5e8f5] shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-[#d81e8f]/10 via-transparent to-[#00a8cc]/10" />
                
                {/* Decorative geometric pattern */}
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#f4a500] opacity-10 rounded-full -mr-16 -mt-16 blur-2xl" />
                  <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#6f2fbf] opacity-10 rounded-full -ml-16 -mb-16 blur-2xl" />
                </div>

                {/* Content card */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[90%] mb-4 rounded-2xl bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-sm px-4 py-3 shadow-lg border border-[#d81e8f]/20 group-hover:shadow-xl transition-all">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#6f2fbf]">Featured</p>
                      <h2 className="text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#d81e8f] to-[#f4a500]">Saffron Silk Kurti</h2>
                    </div>
                    <span className="text-lg font-bold text-[#d81e8f]">₹1,899</span>
                  </div>
                </div>
              </div>
            </div>
