      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid items-center gap-10 md:gap-14 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6 inline-flex items-center gap-2 border-b-2 border-[#7D1D1D] pb-1 text-[11px] font-semibold uppercase tracking-[0.3em] text-[#7D1D1D]">
              Festival Collection 2026
            </div>

            <h1 className="display-hero text-[3.25rem] leading-[0.92] text-[var(--ink)] sm:text-7xl lg:text-[5.5rem]">
              Rooted in tradition.
              <span className="mt-2 block text-[#7D1D1D]">Made for today.</span>
            </h1>

            <p className="mx-auto mt-7 max-w-xl text-base leading-8 text-[var(--ink)]/70 md:text-lg lg:mx-0">
          ...
          <div className="relative mx-auto w-full max-w-md">
            <div className="group relative overflow-hidden rounded-lg border border-[var(--ink)]/10 shadow-[var(--shadow-lg)]">
              <Image
                ...
                width={560}
                height={760}
                className="h-[380px] w-full object-cover transition-transform duration-500 group-hover:scale-105 md:h-[520px]"
                priority
              />
